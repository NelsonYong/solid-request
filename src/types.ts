import { Accessor, AccessorArray } from 'solid-js'
...
export interface UseRequestBasicOptions<TData, TParams extends unknown[]> {
   ...
   *
   */
  loadingDelay?: number | Accessor<number>
   ...
   */
  pollingInterval?: Accessor<number> | number
   ...
   */
  refreshOnWindowFocus?: Accessor<boolean> | boolean

  /**
   * Re-request interval, in milliseconds.
   */
  focusTimespan?: Accessor<number> | number
   ...
   */
  debounceWait?: Accessor<number> | number

  /**
   * Execute the request before the delay starts.
   */
  debounceLeading?: Accessor<boolean> | boolean

  /**
   * Execute the request after the delay ends.
   */
  debounceTrailing?: Accessor<boolean> | boolean

  /**
   * The maximum time request is allowed to be delayed before it’s executed.
   */
  debounceMaxWait?: Accessor<number> | number
   ...
   */
  throttleWait?: Accessor<number> | number

  /**
   * Execute the request before throttling starts.
   */
  throttleLeading?: Accessor<boolean> | boolean

  /**
   * Execute the request after throttling ends.
   */
  throttleTrailing?: Accessor<boolean> | boolean
...
export type UseRequestOptions<TData, TParams extends unknown[], TPlugin> = {
  [K in keyof UseRequestBasicOptions<TData, TParams>]: UseRequestBasicOptions<
    TData,
    TParams
  >[K]
} & {
